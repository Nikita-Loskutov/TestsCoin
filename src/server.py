...
async def start(message: types.Message):
    ...
    web_app_url = f"https://59f8-2a0d-5600-44-9000-00-a6cf.ngrok-free.app/user/{username}?user_id={user_id}"
    ...
    if existing_user:
        ...
        await message.answer(
            ...
            "Твоя реферальная ссылка: " + f'https://59f8-2a0d-5600-44-9000-00-a6cf.ngrok-free.app/invite?referrer_id={user_id}',
