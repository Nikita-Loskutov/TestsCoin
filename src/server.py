...
def mine():
    ...
    card_data_echelon = get_card_data(user, 'echelon')
    card_data_leadger = get_card_data(user, 'leadger')
    card_data_quantum = get_card_data(user, 'quantum')
    card_data_multitap = get_card_data(user, 'multitap')
    return render_template('mine.html', user_id=user_id, card_data_token=card_data_token, card_data_staking=card_data_staking, card_data_genesis=card_data_genesis, card_data_echelon=card_data_echelon, card_data_leadger=card_data_leadger, card_data_quantum=card_data_quantum, card_data_multitap=card_data_multitap)
...
async def start(message: types.Message):
    ...
    web_app_url = f"https://17c2-162-19-19-232.ngrok-free.app/user/{username}?user_id={user_id}"
