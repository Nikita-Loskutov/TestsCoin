...
async def start(message: types.Message):
    ...
    web_app_url = f"https://7007-2a0d-5600-24-5000-00-4eed.ngrok-free.app/user/{username}?user_id={user_id}"
    ...
    if existing_user:
        await message.answer(
            ...
            "Твоя реферальная ссылка: " + f'https://7007-2a0d-5600-24-5000-00-4eed.ngrok-free.app/invite?referrer_id={user_id}',
